                ...
                <div class="col-sm-6">
                    <div class="card text-bg-secondary">
                        <div class="text-center pt-5">
                            <img src="../img/bg.jpg" class="thumbneil" width="300px" height="200px">
                        </div>
                        <div class="card-body" style="font-family: cambria;">
                            <div class="text-center">
                                <label class="mb-3">Login dulu untuk melakukan booking.</label>
                            </div>
                        ...
                        ?>
                            ...
                            <div class="row pt-3">
                                <div class="col-sm-6">
                                    <p style="font-family: cambria; text-align: center; padding-top: 3%;">Anda belum punya akun.?</p>                
                                </div>
                                <div class="col-sm-6">
                                    <a href="log_up.php" class="btn btn-danger"  style="font-family: cambria; float: right;">Buat Akun <i class="fa-solid fa-user-plus"></i></a>
                                </div>
                            </div>
